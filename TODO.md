...
- **beatoraja-result remaining stubs:** MainController (6 methods), PlayDataAccessor, BMSPlayerInputProcessor, IRStatus/IRSendStatusMain, BMSPlayerMode/BMSPlayerModeType, IntArray, SkinObjectData, EventType, freq_trainer stubs. PlayerResource wrapper complete but non-trait field types (BMSModel, BMSPlayerMode, RankingData) are still stored locally
