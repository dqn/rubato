...
- **beatoraja-select remaining stubs:** MainState trait (empty marker), RandomCourseData/RandomStageData, RankingData/RankingDataCache, SkinText/SkinNumber/SkinImage/SkinObject/SkinObjectRenderer, EventType, AudioDriver, TimerState, NullSongDatabaseAccessor, DownloadTask/DownloadTaskState/DownloadTaskStatus. BMSPlayerMode/PlayerInformation replaced (18e-7). Dead Pair removed (18e-7). SongManagerMenu now delegates to beatoraja-types (18e-8). BMSPlayerInputProcessor/ControlKeys/KeyCommand replaced with real beatoraja-input types (18e-9). **Blocked:** rendering stubs (rendering pipeline), RandomCourseData (database queries)
