...
impl BMSPlayer {
    ...
    pub fn new_with_resource_gen(model: BMSModel, song_resource_gen: i32) -> Self {
        ...
        BMSPlayer {
            ...
            song_metadata: crate::skin::song_data::SongMetadata::default(),
            song_data: None,
            player_data: None,
    ...
    /// via `bga()` and inject it here.
    /// After `create()`, the processor is stored back via `set_bga()`.
    ///
    ...
    pub fn set_analysis_result(
        &mut self,
        result: Option<crate::audio::bms_loudness_analyzer::AnalysisResult>,
    ) {
    ...
    pub fn set_config(&mut self, config: crate::skin::config::Config) {
        self.config = config;
    }
    ...
    pub(super) fn queue_sound(&mut self, sound: crate::skin::sound_type::SoundType) {
    ...
    /// Use `crate::skin::skin_render_context::compute_lnmode_from_chart()` to compute.
    ...
    pub fn song_metadata(&self) -> &crate::skin::song_data::SongMetadata {
        &self.song_metadata
    }

    /// Set the song metadata for skin string property queries (title, artist, etc.).
    /// Should be called during initialization when SongData is available.
    pub fn set_song_metadata(&mut self, metadata: crate::skin::song_data::SongMetadata) {
        self.song_metadata = metadata;
    }

    /// Get the song data used for boolean skin property queries.
    pub fn song_data(&self) -> Option<&crate::skin::song_data::SongData> {
    ...
    pub fn set_song_data(&mut self, song_data: crate::skin::song_data::SongData) {
    ...
    pub fn set_player_data(&mut self, data: crate::skin::player_data::PlayerData) {
    ...
    pub fn set_offset_snapshot(&mut self, offsets: Vec<crate::skin::skin_offset::SkinOffset>) {
        self.offset_snapshot = offsets;
    }

    /// Get a reference to the offset snapshot for read access.
    pub fn offset_snapshot(&self) -> &[crate::skin::skin_offset::SkinOffset] {
    ...
    pub fn offset_snapshot_mut(&mut self) -> &mut Vec<crate::skin::skin_offset::SkinOffset> {
    ...
    pub fn drain_pending_bg_notes(&self) -> Vec<crate::play::key_sound_processor::BgNoteCommand> {
    ...
    pub fn apply_loudness_analysis(
        &mut self,
        analysis_result: &crate::audio::bms_loudness_analyzer::AnalysisResult,
