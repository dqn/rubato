...
use crate::skin::json::json_skin;
use crate::skin::json::json_skin_loader::{
    JSONSkinLoader, SkinConfigProperty, SkinData, SkinHeaderData,
};
use crate::skin::lua::skin_lua_accessor::SkinLuaAccessor;
...
impl LuaSkinLoader {
    ...
    pub fn new_with_state(state: &mut dyn MainState, config: &crate::skin::config::Config) -> Self {
    ...
    pub fn new_without_state(config: &crate::skin::config::Config) -> Self {
        Self {
            lua: SkinLuaAccessor::new(false),
    ...
    pub fn load(
        ...
        self.json_loader.serializer =
            Some(crate::skin::json::json_skin_serializer::JsonSkinSerializer::new());
        self.json_loader
...
mod tests {
    ...
    use crate::skin::objects::wiring_check::{Severity, WiringCheck};
    ...
    fn test_load_default_decide_lua_skin_without_state() {
        ...
        assert_eq!(
            header.skin_type,
            crate::skin::skin_type::SkinType::Decide.id()
        );
    ...
    fn test_load_default_play_lua_skin_without_state() {
        ...
        assert_eq!(
            header.skin_type,
            crate::skin::skin_type::SkinType::Play7Keys.id()
        );
    ...
    fn test_load_ecfn_result_lua_skin_with_state() {
        ...
        assert_eq!(
            header.skin_type,
            crate::skin::skin_type::SkinType::Result.id()
        );
    ...
    fn test_ecfn_play_lua_skin_wires_judge_images() {
        ...
        let judge = skin
            ...
            .find_map(|obj| {
                obj.as_any()
                    .downcast_ref::<crate::skin::skin_judge_object::SkinJudgeObject>()
            })
    ...
    fn test_ecfn_select_lua_skin_converts_title_to_bitmap_text() {
        ...
        let has_title_bitmap = skin.objects().iter().any(|obj| {
            obj.as_any()
                .downcast_ref::<crate::skin::text::skin_text_bitmap::SkinTextBitmap>()
                .is_some()
    ...
    fn test_ecfn_select_lua_skin_preserves_songlist_bitmap_bartext() {
        ...
        assert!(
            matches!(
                ...
                Some(crate::skin::skin_text::SkinTextEnum::Bitmap(_))
            ),
    ...
    fn test_ecfn_select_lua_skin_with_state_renders_songlist_bitmap_bartext() {
        ...
        {
            Some(crate::skin::skin_text::SkinTextEnum::Bitmap(text)) => text,
            _ => panic!("expected bitmap songlist text"),
        };
        bar_text.text_data.data.draw = true;
        bar_text.text_data.data.region =
            crate::skin::reexports::Rectangle::new(155.0, 13.0, 580.0, 24.0);
