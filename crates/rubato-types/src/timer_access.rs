...
impl TimerAccess for NullTimer {
    ...
    fn micro_timer(&self, _timer_id: i32) -> i64 {
        i64::MIN
    }

    fn timer(&self, _timer_id: i32) -> i64 {
        i64::MIN / 1000
    }

    fn now_time_for(&self, _timer_id: i32) -> i64 {
        0
    }
...
mod tests {
    ...
    fn test_null_timer_defaults() {
        ...
        assert_eq!(timer.micro_timer(0), i64::MIN);
        assert!(!timer.is_timer_on(0));
        assert_eq!(timer.now_time_for(0), 0);
    }
