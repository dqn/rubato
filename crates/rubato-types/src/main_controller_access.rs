...
// ---------------------------------------------------------------------------
// Sub-trait 1: ControllerConfigAccess (Config access)
// ---------------------------------------------------------------------------

/// Read-only access to Config and PlayerConfig.
pub trait ControllerConfigAccess {
...
// ---------------------------------------------------------------------------
// Sub-trait 2: StateTransitionAccess (State changes)
// ---------------------------------------------------------------------------

/// State transition, save, and exit operations.
pub trait StateTransitionAccess {
...
// ---------------------------------------------------------------------------
// Sub-trait 3: AudioSystemAccess (Sound/audio)
// ---------------------------------------------------------------------------

/// Sound effect and audio path operations.
pub trait AudioSystemAccess {
...
// ---------------------------------------------------------------------------
// Sub-trait 4: IRConnectionAccess (IR access)
// ---------------------------------------------------------------------------

/// Internet Ranking connection and rival information.
pub trait IRConnectionAccess {
...
// ---------------------------------------------------------------------------
// Sub-trait 5: DataReadAccess (Score/replay reading + downloads)
// ---------------------------------------------------------------------------

/// Score data, replay data, song info, and download operations.
pub trait DataReadAccess {
...
// ---------------------------------------------------------------------------
// MainControllerAccess: super-trait combining all 5 sub-traits
// ---------------------------------------------------------------------------
...
impl ControllerConfigAccess for NullMainController {
    fn config(&self) -> &Config {
...
impl StateTransitionAccess for NullMainController {
...
impl AudioSystemAccess for NullMainController {}

impl IRConnectionAccess for NullMainController {}

impl DataReadAccess for NullMainController {}
...
impl ControllerConfigAccess for ConfigMainControllerAccess {
    fn config(&self) -> &Config {
        &self.config
    }
    fn player_config(&self) -> &PlayerConfig {
...
impl StateTransitionAccess for ConfigMainControllerAccess {
    fn change_state(&mut self, _state: MainStateType) {
...
impl AudioSystemAccess for ConfigMainControllerAccess {}

impl IRConnectionAccess for ConfigMainControllerAccess {}

impl DataReadAccess for ConfigMainControllerAccess {}
