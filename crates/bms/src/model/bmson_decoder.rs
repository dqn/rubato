...
use crate::model::bms_decoder::convert_hex_string;
use crate::model::bms_model::{BMSModel, JudgeRankType, TotalType};
use crate::model::bmson;
use crate::model::chart_decoder::TimeLineCache;
use crate::model::chart_information::ChartInformation;
use crate::model::decode_log::{DecodeLog, State};
use crate::model::layer::{Event, EventType, Layer, Sequence as LayerSequence};
use crate::model::mode::Mode;
use crate::model::note::Note;
use crate::model::time_line::TimeLine;

pub struct BMSONDecoder {
    pub lntype: crate::model::bms_model::LnType,
...
impl BMSONDecoder {
    pub fn new(lntype: crate::model::bms_model::LnType) -> Self {
        BMSONDecoder {
            lntype,
            log: Vec::new(),
        }
...
mod tests {
    ...
    fn test_decode_minimal_7k() {
        ...
        assert_eq!(
            model.title, "Minimal 7K Bmson Test",
    ...
    fn test_decode_mine_invisible() {
        ...
        let mines: Vec<&crate::model::note::Note> = timelines
            .iter()
    ...
    fn test_decode_chart_information_without_path() {
        let info = ChartInformation::new(None, crate::model::bms_model::LnType::LongNote, None);
        let mut decoder = BMSONDecoder::new(crate::model::bms_model::LnType::LongNote);
