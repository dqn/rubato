use crate::state::select::ScoreData;
...
mod tests {
    use super::*;
    use crate::state::select::bar::command_bar::CommandBar;
    use crate::state::select::bar::container_bar::ContainerBar;
    use crate::state::select::bar::folder_bar::FolderBar;
    use crate::state::select::bar::function_bar::FunctionBar;
    use crate::state::select::bar::grade_bar::GradeBar;
    use crate::state::select::bar::hash_bar::HashBar;
    use crate::state::select::bar::random_course_bar::RandomCourseBar;
    use crate::state::select::bar::same_folder_bar::SameFolderBar;
    use crate::state::select::bar::search_word_bar::SearchWordBar;
    use crate::state::select::bar::song_bar::SongBar;
    use crate::state::select::bar::table_bar::TableBar;
