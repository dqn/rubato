...
mod tests {
    ...
    fn test_trait_prepare_delegates_to_do_prepare() {
        ...
        assert_eq!(
            cr.data.state,
            crate::state::result::abstract_result::STATE_OFFLINE
        );
    }
    ...
    use crate::state::result::ir_status::IRStatus as IRStatusReal;
    ...
    impl crate::state::result::IRConnection for MockCourseIR {
    ...
    fn make_ir_course_result(
        ir_conn: Arc<dyn crate::state::result::IRConnection + Send + Sync>,
    ) -> CourseResult {
    ...
    fn test_prepare_with_ir_transitions_to_ir_finished() {
        ...
        assert_eq!(
            cr.data.state,
            crate::state::result::abstract_result::STATE_IR_FINISHED
        );
    }
