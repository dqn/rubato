...
use crate::state::result::shared_render_context;
use crate::state::result::{MainController, PlayerResource};
...
impl rubato_types::skin_render_context::SkinRenderContext for ResultRenderContext<'_> {
    ...
    fn gauge_transition_last_value(&self, gauge_type: i32) -> Option<f32> {
        shared_render_context::gauge_transition_last_value(self.resource, gauge_type)
    }
    ...
    fn boolean_value(&self, id: i32) -> bool {
        match id {
            ...
            32 => {
                self.resource.play_mode().mode != crate::core::bms_player_mode::Mode::Autoplay
...
impl rubato_types::skin_render_context::SkinRenderContext for ResultMouseContext<'_> {
    ...
    fn gauge_transition_last_value(&self, gauge_type: i32) -> Option<f32> {
        shared_render_context::gauge_transition_last_value(&self.result.resource, gauge_type)
    }
        ...
        match id {
            ...
            32 => {
                self.result.resource.play_mode().mode
                    ...
                    && self.result.resource.play_mode().mode
                        != crate::core::bms_player_mode::Mode::Replay
            }
            33 => {
                self.result.resource.play_mode().mode
                    == crate::core::bms_player_mode::Mode::Autoplay
