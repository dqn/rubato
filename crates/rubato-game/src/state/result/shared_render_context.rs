...
pub fn integer_value(
    ...
    match id {
        ...
        312 => songdata.map_or(0, |s| s.chart.length),

        // ---- Song duration minutes (NUMBER_DURATION_MINUTE: 1163) ----
        // Java: (songdata.getLength() / 60000) % 60
        1163 => songdata.map_or(i32::MIN, |s| (s.chart.length.max(0) / 60000) % 60),

        // ---- Song duration seconds (NUMBER_DURATION_SECOND: 1164) ----
        // Java: (songdata.getLength() / 1000) % 60
        1164 => songdata.map_or(i32::MIN, |s| (s.chart.length.max(0) / 1000) % 60),

        // ---- Chart level (NUMBER_LEVEL: 96) ----
...
pub fn target_score_data(resource: &PlayerResource) -> Option<&crate::core::score_data::ScoreData> {
    resource.target_score_data()
}

pub fn score_data_ref(data: &AbstractResultData) -> Option<&crate::core::score_data::ScoreData> {
    data.score.score.as_ref()
}

pub fn rival_score_data_ref(
    data: &AbstractResultData,
) -> Option<&crate::core::score_data::ScoreData> {
    Some(&data.oldscore)
}
...
pub fn judge_area(resource: &PlayerResource) -> Option<Vec<Vec<i32>>> {
    ...
    let rule = crate::play::bms_player_rule::BMSPlayerRule::for_mode(&mode);
...
mod tests {
    ...
    fn test_boolean_value_course_score_affects_clear_and_fail() {
        ...
        let mut data = AbstractResultData::new();
        let mut stage_score = crate::core::score_data::ScoreData::default();
        ...
        let mut course_clear = crate::core::score_data::ScoreData::default();
        ...
        let mut course_fail = crate::core::score_data::ScoreData::default();
        ...
        let mut stage_fail = crate::core::score_data::ScoreData::default();
    ...
    fn make_ranking_with_scores() -> crate::ir::ranking_data::RankingData {
    ...
    fn make_named_ranking_with_scores() -> crate::ir::ranking_data::RankingData {
        use crate::ir::ir_score_data::IRScoreData;
        use crate::ir::ranking_data::RankingData;
    ...
    fn make_data_with_score() -> AbstractResultData {
        ...
        data.oldscore = crate::core::score_data::ScoreData::default();
    ...
    fn test_integer_value_ir_rank_with_ranking() {
        ...
        let mut ranking = crate::ir::ranking_data::RankingData::new();
        let scores: Vec<IRScoreData> = vec![
            {
                let mut s = crate::core::score_data::ScoreData::default();
    ...
    fn test_float_value_zero_scorerate_not_confused_with_unmatched() {
        ...
        let mut data = AbstractResultData::new();
        data.score.rate = 0.0;
        data.score.score = Some(crate::core::score_data::ScoreData::default());
