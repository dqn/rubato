...
use crate::play::lane_property::LaneProperty;
...
mod tests {
    ...
    fn test_judge_thread_new_sets_fields() {
        ...
        assert_eq!(
            jt.last_time,
            1_000_000 + crate::play::bms_player::TIME_MARGIN * 1000
        );
    ...
    fn test_judge_thread_tick_past_last_time_finishes() {
        ...
        let past_time = last_tl_time + crate::play::bms_player::TIME_MARGIN * 1000;
