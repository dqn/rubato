...
use crate::core::course_data::{CourseData, CourseDataConstraint};
...
pub struct PlayerResource {
    ...
    /// Ranking data
    ranking: Option<crate::ir::ranking_data::RankingData>,
    ...
    /// BGA processor for reuse across plays.
    /// Java: BMSResource holds BGAProcessor, reused via PlayerResource.getBGAManager().
    bga: Option<Arc<Mutex<crate::play::bga::bga_processor::BGAProcessor>>>,
...
impl PlayerResource {
    ...
    pub fn ranking_data(&self) -> Option<&crate::ir::ranking_data::RankingData> {
        self.ranking.as_ref()
    }

    pub fn set_ranking_data(&mut self, ranking: Option<crate::ir::ranking_data::RankingData>) {
        self.ranking = ranking;
    }

    pub fn bga(&self) -> Option<&Arc<Mutex<crate::play::bga::bga_processor::BGAProcessor>>> {
        self.bga.as_ref()
    }

    pub fn set_bga(&mut self, bga: Arc<Mutex<crate::play::bga::bga_processor::BGAProcessor>>) {
        self.bga = Some(bga);
    }
    ...
    pub fn reverse_lookup_data(&self) -> Vec<String> {
        ...
        let url_set: std::collections::HashSet<&str> = self
            ...
            .map(|s| s.as_str())
            .collect();
        let tdaccessor = crate::core::table_data_accessor::TableDataAccessor::new(
...
impl SessionMutation for PlayerResource {
    ...
    fn set_bms_file(&mut self, path: &Path, mode_type: i32, mode_id: i32) -> bool {
        let mode = match mode_type {
            0 => BMSPlayerMode::new(crate::core::bms_player_mode::Mode::Play),
            1 => BMSPlayerMode::new(crate::core::bms_player_mode::Mode::Practice),
            2 => BMSPlayerMode::new(crate::core::bms_player_mode::Mode::Autoplay),
            3 => BMSPlayerMode::new_with_id(crate::core::bms_player_mode::Mode::Replay, mode_id),
            _ => BMSPlayerMode::new(crate::core::bms_player_mode::Mode::Play),
        };
