...
use rubato_core::pattern::extra_note_modifier::ExtraNoteModifier;
use rubato_core::pattern::lane_shuffle_modifier::{PlayerBattleModifier, PlayerFlipModifier};
use rubato_core::pattern::long_note_modifier::LongNoteModifier;
use rubato_core::pattern::mine_note_modifier::MineNoteModifier;
use rubato_core::pattern::mode_modifier::ModeModifier;
...
mod tests {
    ...
    fn select_gauge_type_no_replay_uses_config() {
        let key_state = ReplayKeyState::default();
        let result =
            BMSPlayer::select_gauge_type(None, rubato_types::groove_gauge::NORMAL, &key_state);
