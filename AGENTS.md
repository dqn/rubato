...
| 16a–c | Tests: 715 unit + 121 golden master + 32 integration (compare_rule + compare_pattern reactivated with Java LCG fix). 16b partial: 2 duplicate pending tests deleted; 9 e2e tests activated (Phase 18f); 2 pending tests activated by 18d; 2 remaining blocked by fixture files; `compare_judge_manager.rs` + `compare_audio.rs` activated |
