// LibGDX rendering type stubs — deferred to Phase 13 (Bevy replacement).
// These types represent com.badlogic.gdx graphics primitives that will be replaced
// with Bevy equivalents when the rendering pipeline is implemented.
