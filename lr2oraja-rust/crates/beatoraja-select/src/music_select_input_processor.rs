...
mod tests {
    ...
    fn test_bar_type_classify_song() {
        ...
        let bar = Bar::Song(Box::new(crate::bar::song_bar::SongBar::new(song_data)));
    ...
    fn test_bar_type_classify_function() {
        let bar = Bar::Function(Box::new(crate::bar::function_bar::FunctionBar::new(
            "test".to_string(),
            0,
        )));
    ...
    fn test_bar_type_classify_grade() {
        ...
        let bar = Bar::Grade(Box::new(crate::bar::grade_bar::GradeBar::new(
            CourseData::default(),
        )));
