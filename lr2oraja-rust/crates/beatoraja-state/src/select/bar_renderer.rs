...
impl BarRenderer {
    ...
    pub fn render(
        ...
        let download_tasks =
            beatoraja_song::md_processor::download_task_state::DownloadTaskState::get_running_download_tasks();
...
mod tests {
    ...
    impl MainState for MockMainState {
        ...
        fn get_image(&self, _id: i32) -> Option<beatoraja_skin::stubs::TextureRegion> {
            None
        }
