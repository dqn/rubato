...
mod tests {
    ...
    fn test_write_with_filename() {
        ...
        assert_eq!(read_back.unwrap().get_name(), "Custom Table");
    }
    ...
    fn test_load_new_table_data_skips_existing() {
        ...
        assert!(cached.is_some());
        assert_eq!(cached.unwrap().get_name(), "Existing Table");
    }
