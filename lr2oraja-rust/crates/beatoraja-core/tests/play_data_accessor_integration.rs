...
use beatoraja_core::play_data_accessor::PlayDataAccessor;
...
fn write_then_read_score() {
    ...
    assert_eq!(restored.epg, 100);
    assert_eq!(restored.lpg, 90);
    assert_eq!(restored.egr, 50);
    assert_eq!(restored.lgr, 40);
    assert_eq!(restored.egd, 10);
    assert_eq!(restored.lgd, 8);
    assert_eq!(restored.ebd, 3);
    assert_eq!(restored.lbd, 2);
    assert_eq!(restored.epr, 1);
    assert_eq!(restored.lpr, 1);
